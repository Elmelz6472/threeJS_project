...
const geometry_cone = new THREE.DodecahedronBufferGeometry(7);
const material_cone = new THREE.MeshStandardMaterial({color: 0xff6347, wireframe: false});

const cone = new THREE.Mesh(geometry_cone, material_cone)


torus.position.set(1, 1, 1)
cone.position.set(10, -5, 100)

scene.add(torus, cone)
